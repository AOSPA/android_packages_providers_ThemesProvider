...
import cm.theme.platform.Manifest;
...
public class ProviderUtils {
     ...
     * being processed by {@link cm.theme.platform.internal.ThemeManagerService}
     * @param context
     * @param pkgName
    ...
    /**
     * Sends the {@link cm.theme.content.Intent#ACTION_THEME_INSTALLED} action
     * @param context
     * @param pkgName
     */
    public static void sendThemeInstalledBroadcast(Context context, String pkgName) {
        Intent intent = new Intent(cm.theme.content.Intent.ACTION_THEME_INSTALLED,
                Uri.fromParts(cm.theme.content.Intent.URI_SCHEME_PACKAGE, pkgName, null));
        context.sendBroadcast(intent, Manifest.permission.READ_THEMES);
    }

    /**
     * Sends the {@link cm.theme.content.Intent#ACTION_THEME_UPDATED} action
     * @param context
     * @param pkgName
     */
    public static void sendThemeUpdatedBroadcast(Context context, String pkgName) {
        Intent intent = new Intent(cm.theme.content.Intent.ACTION_THEME_UPDATED,
                Uri.fromParts(cm.theme.content.Intent.URI_SCHEME_PACKAGE, pkgName, null));
        context.sendBroadcast(intent, Manifest.permission.READ_THEMES);
    }
    ...
    public static void sendThemeRemovedBroadcast(Context context, String pkgName) {
        Intent intent = new Intent(cm.theme.content.Intent.ACTION_THEME_REMOVED,
                Uri.fromParts(cm.theme.content.Intent.URI_SCHEME_PACKAGE, pkgName, null));
        context.sendBroadcast(intent, Manifest.permission.READ_THEMES);
    }
}
